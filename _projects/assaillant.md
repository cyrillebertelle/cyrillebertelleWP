...
layout: page
title: Assaillant
description: Projet émergeant soutenu par la Région Normandie 
img: /assets/img/assaillant.jpeg
importance: 10
category: latest projects
---
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/assaillant.jpeg' | relative_url }}" alt="" title="assaillant logo"/>
    </div>
</div>
<!-- 
<div class="caption">
